...
<div class="max-w-4xl mx-auto p-6 bg-white shadow-md rounded-lg">
    ...
    <form action="/persona" method="POST" class="space-y-4">
        <!-- CSRF token si usas Blade -->
         @csrf 
        ...
        <div class="grid grid-cols-2 gap-4">
            ...
            <div>
                <label class="block text-gray-700">Lugar de Nacimiento:</label>
                <input type="text" name="lugar_nacimiento" class="w-full p-2 border rounded" required>
            </div>
            <div>
        ...
        <div class="mt-6">
            <button type="submit" class="bg-blue-600 text-white py-2 px-6 rounded hover:bg-blue-700 transition">Guardar</button>
        </div>
    </form>
</div>
