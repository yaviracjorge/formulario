...
<body class="bg-gray-50 min-h-screen flex items-center justify-center">
    ...
    <div class="w-full max-w-2xl bg-white shadow-md rounded-lg p-8">
        ...
        <form action="{{ route('asignaciones.store') }}" method="POST" class="space-y-4">
            @csrf
            ...
            <div>
                ...
                <input type="text" id="cargo" name="cargo" required placeholder="Escribe el cargo"
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" />
            </div>
            ...
            <div>
                ...
                <input type="text" id="tiempo_dedicacion" name="tiempo_dedicacion" required placeholder="Ej: T100, T60, etc."
                    class="w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500" />
            </div>
            ...
            <!-- Lugar de sufragio (Opcional: confirma si quieres mantenerlo) -->
            <div>
